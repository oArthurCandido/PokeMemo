...
const CardButton = ({
  ...
  return (
    <button
      ...
      key={index}
      className={CN(
        "transition-all duration-700 portrait:w-[20%] portrait:h-[16%] landscape:w-[16%] landscape:h[18%]  rounded-md text-center flex items-center justify-center text-4xl font-bold border border-slate-600  overflow-hidden m-1",
        {
